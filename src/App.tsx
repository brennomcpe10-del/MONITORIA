...
export default function App() {
  return (
    <div style={{ padding: '40px', fontFamily: 'sans-serif', textAlign: 'center' }}>
      <h1 style={{ color: '#2563eb' }}>Sistema de Monitoria</h1>
      <p>O site está sendo carregado corretamente!</p>
      <div style={{ marginTop: '20px', padding: '20px', border: '1px solid #ddd', borderRadius: '8px' }}>
        <p>Se você está vendo isso, a conexão com a Vercel funcionou. Vencemos!</p>
      </div>
    </div>
  );
}